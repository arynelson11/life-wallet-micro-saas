    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in-up">
            ...
            <div className="space-y-6 col-span-2 md:col-span-1">
                ...
                <div className="orvion-card p-6 flex items-center justify-center border-dashed border-2 border-zinc-200 cursor-pointer hover:bg-zinc-50 transition-colors">
                    <div className="text-center text-zinc-500">
                        <Plus className="w-8 h-8 mx-auto mb-2" />
                        <p className="font-medium">Adicionar Nova Fonte</p>
                    </div>
                </div>
            </div>
        </div>
...
import { Plus } from "lucide-react"; // Forgot to import Plus
